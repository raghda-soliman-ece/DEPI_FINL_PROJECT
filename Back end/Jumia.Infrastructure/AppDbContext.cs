...
{
    // Inheriting from IdentityDbContext to enable Identity features with our custom classes
    public class AppDbContext : IdentityDbContext<AppUser, Role, string, IdentityUserClaim<string>, UserRole, IdentityUserLogin<string>, IdentityRoleClaim<string>, IdentityUserToken<string>>
    {
        public AppDbContext(DbContextOptions<AppDbContext> options) : base(options)
        {
        }

        // Users, Roles, and UserRoles DbSets are provided automatically by IdentityDbContext
        ...
        {
            // Essential for Identity configuration
